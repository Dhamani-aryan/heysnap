...
npm install -g vercel@latest @openai/codex@latest @heysnap-ai/web @heysnap-ai/chrome-controller-cli heysnap-image-gen@0.1.1 docx pptxgenjs react-icons react react-dom sharp
